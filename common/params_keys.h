...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ComfortBrake", {PERSISTENT, INT, "235"}},
    ...
    {"LongTuningKf", {PERSISTENT, INT, "90"}},
    {"LongActuatorDelay", {PERSISTENT, INT, "20"}},
    {"VEgoStopping", {PERSISTENT, INT, "20"}},
    ...
    {"LateralTorqueAccelFactor", {PERSISTENT, INT, "2000"}},
    {"LateralTorqueFriction", {PERSISTENT, INT, "140"}},
    {"LateralTorqueKpV", {PERSISTENT, INT, "138"}},
    {"LateralTorqueKiV", {PERSISTENT, INT, "25"}},
    {"LateralTorqueKf", {PERSISTENT, INT, "90"}},
    {"LateralTorqueKd", {PERSISTENT, INT, "25"}},

    {"CustomSteerMax", {PERSISTENT, INT, "300"}},
    {"CustomSteerDeltaUp", {PERSISTENT, INT, "11"}},
    {"CustomSteerDeltaDown", {PERSISTENT, INT, "13"}},
    {"CustomSteerDeltaUpLC", {PERSISTENT, INT, "17"}},
    {"CustomSteerDeltaDownLC", {PERSISTENT, INT, "12"}},
    ...
    {"StartupServiceCheckTime", {PERSISTENT, INT, "30"}},
