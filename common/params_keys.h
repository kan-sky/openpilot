...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoCurveSpeedLowerLimit", {PERSISTENT, INT, "43"}},
    ...
    {"AutoTurnControlTurnEnd", {PERSISTENT, INT, "3"}},
    ...
    {"ModelTurnSpeedFactor", {PERSISTENT, INT, "40"}},
    ...
    {"LongTuningKpV", {PERSISTENT, INT, "107"}},
    {"LongTuningKiV", {PERSISTENT, INT, "0"}},
    {"LongTuningKf", {PERSISTENT, INT, "104"}},
    ...
    {"AdjustCurveOffset", {PERSISTENT, INT, "-25"}},
    ...
    {"LateralTorqueKpV", {PERSISTENT, INT, "130"}},
    {"LateralTorqueKiV", {PERSISTENT, INT, "15"}},
    {"LateralTorqueKf", {PERSISTENT, INT, "85"}},
    {"LateralTorqueKd", {PERSISTENT, INT, "20"}},
