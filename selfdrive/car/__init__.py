...
def dbc_dict(pt_dbc, radar_dbc, chassis_dbc=None, body_dbc=None, gmlan_dbc=None) -> Dict[str, str]:
  return {'pt': pt_dbc, 'radar': radar_dbc, 'chassis': chassis_dbc, 'body': body_dbc, 'gmlan': gmlan_dbc}
