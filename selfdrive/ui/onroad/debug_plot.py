...
class DebugPlot(Widget):
  ...
  def _render(self, rect: rl.Rectangle):
    ...
    rl.draw_text_ex(self._font_display, title, rl.Vector2(x0 + 10, y0 + 8), 26, 0, rl.WHITE)
    min_max = f"min={self.plot_min:.2f}, max={self.plot_max:.2f}"
    rl.draw_text_ex(self._font_display, min_max, rl.Vector2(x0 + 10, y0 + 40), 26, 0, rl.WHITE)
