...
class SelfdriveD:
  def __init__(self, CP=None):
    ...
    self.startup_event = EventName.startup #  # Kans
  ...
  def update_events(self, CS):
    ...
    # Kans: fix dadar faults
    # Debug
    if self.sm['radarState'].radarErrors.canError or \
       self.sm['radarState'].radarErrors.radarFault or \
       self.sm['radarState'].radarErrors.radarUnavailableTemporary:
      print(
        f"SELF_RADAR v={int(self.sm.valid['radarState'])} "
        f"can={int(self.sm['radarState'].radarErrors.canError)} "
        f"fault={int(self.sm['radarState'].radarErrors.radarFault)} "
        f"temp={int(self.sm['radarState'].radarErrors.radarUnavailableTemporary)}"
      )
    if self.sm['radarState'].radarErrors.canError:
      self.events.add(EventName.canError)
    elif self.sm['radarState'].radarErrors.radarUnavailableTemporary:
      self.events.add(EventName.radarTempUnavailable)
    elif self.sm['radarState'].radarErrors.radarFault:
