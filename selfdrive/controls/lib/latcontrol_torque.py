...
class LatControlTorque(LatControl):
  def __init__(self, CP, CI):
    ...
    #self.sm = messaging.SubMaster(['livePose', 'liveCalibration'])
  ...
  def update(self, active, CS, VM, params, steer_limited, desired_curvature, llk, model_data=None):
    ...
    #  llk = Pose.from_live_pose(self.sm['livePose'])
    #  self.calibrated_pose = self.pose_calibrator.build_calibrated_pose(llk)
