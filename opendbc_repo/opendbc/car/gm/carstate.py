...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, _, __, loopback_cp) -> structs.CarState:
    ...
    # t_Follow Cruise Gap
    ret.cruiseState.leadDistanceBars = self.t_Follow_level
    ...
    if self.distance_button_pressed and self.distance_button_pressed != self.prev_distance_button:
       self.t_Follow_level -= 1
       if self.t_Follow_level < 1:
         self.t_Follow_level = 3
	
    return ret

  def get_t_Follow_level(self):
    return self.t_Follow_level
