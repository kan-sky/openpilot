    ...
    if self.CP.openpilotLongitudinalControl:
      ...
      if self.frame % 4 == 0:
        ...
        if self.CP.carFingerprint not in ALT_ACCS:
          ...
          reopen_delay = min(self.resumeDelay_time * 1.5, 0.24)
          ...
          lead_start = has_lead and (lead_drel < 15.0) and (lead_vrel > 0.3) and near_stop_ego
          ...
          if self.resume_fault_guard == -1:
            ...
            # creep release 유지 시간 동안 브레이크만 0으로 풀어준다
            elif creep_dt < 0.22:
              self.apply_brake = 0
          ...
          resume_active = (self.resume_frame != 0) and auto_longcontrol and (CS.out.vEgo < 3.5) and lead_ok and (starting or CS.out.cruiseState.enabled)
