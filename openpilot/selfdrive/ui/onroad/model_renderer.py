...
class ModelRenderer(Widget):
  ...
  def _update_path_end_carrot(self, sm):
    ...
    if lead_one is not None and lead_one.present:
  ...
  def _draw_blind_spot_carrot(self, sm):
    ...
    elif lead_left.present and float(lead_left.dRel) < float(car_state.vEgo) * 3.0 and left_lane_change:
    ...
    elif lead_right.present and float(lead_right.dRel) < float(car_state.vEgo) * 3.0 and right_lane_change:
