...
class LatControl(ABC):
  ...
  @abstractmethod
  def update(self, active: bool, CS, VM, params, steer_limited_by_controls: bool, desired_curvature: float, CC, curvature_limited: bool, model_data=None, lat_delay: float=0.0):
