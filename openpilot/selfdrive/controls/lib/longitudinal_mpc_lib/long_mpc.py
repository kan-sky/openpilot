...
X_EGO_OBSTACLE_COST = 5.  # stock 3.; devel matches this - reacts to distance error sooner instead of waiting
X_EGO_COST = 0.
V_EGO_COST = 0.
A_EGO_COST = 0.
J_EGO_COST = 5.
...
CRASH_DISTANCE = .25
LEAD_DANGER_FACTOR = 0.8  # stock 0.75; matches devel
LIMIT_COST = 1e6
...
COMFORT_BRAKE = 2.0  # stock 2.5; lowered so the MPC plans to brake earlier for a lead
STOP_DISTANCE = 7.5  # stock 6.0; raised since observed stop gap tracked ~1.5-2m short of target
