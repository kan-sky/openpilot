...
class CarrotNaviCerealPublisher:
  ...
  def _run(self) -> None:
    ...
    while not self._stop.is_set():
      ...
      self.receiver.wait_for_state_change(
        max(0.0, PUBLISH_HEARTBEAT_SECONDS - elapsed)
      )
      ...
      if elapsed < PUBLISH_COALESCE_SECONDS:
        if self._stop.wait(PUBLISH_COALESCE_SECONDS - elapsed):
          return
      ...
      if (
        ...
        and elapsed < PUBLISH_HEARTBEAT_SECONDS
      ):
        continue
