...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"DisableUpdates", {PERSISTENT, BOOL, "1"}},
    ...
    {"AutoTurnControlSpeedTurn", {PERSISTENT, INT, "95"}},
    ...
    {"CruiseButtonTest1", {PERSISTENT, INT, "0"}},
    {"CruiseButtonTest2", {PERSISTENT, INT, "0"}},
    {"CruiseButtonTest3", {PERSISTENT, INT, "0"}},
    ...
    {"LatMpcAccelCost", {PERSISTENT, INT, "100"}},
    {"LatMpcInputOffset", {PERSISTENT, INT, "4"}},
    {"LatMpcJerkCost", {PERSISTENT, INT, "1"}},
    ...
    {"ShowPathColor", {PERSISTENT, INT, "12"}},
    {"ShowPathColorCruiseOff", {PERSISTENT, INT, "1"}},
    {"ShowPathColorLane", {PERSISTENT, INT, "3"}},
    {"ShowPathEnd", {PERSISTENT, INT, "1"}},
    {"ShowPathMode", {PERSISTENT, INT, "9"}},
    {"ShowPathModeLane", {PERSISTENT, INT, "11"}},
    {"ShowPlotMode", {PERSISTENT, INT, "0"}},
    {"ShowRadarInfo", {PERSISTENT, INT, "0"}},
